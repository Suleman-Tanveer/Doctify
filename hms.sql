...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 03, 2016 at 09:47 AM
...
--
ALTER TABLE `appointments`
  ADD CONSTRAINT `appointments_ibfk_2` FOREIGN KEY (`patient_id`) REFERENCES `patient_data` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `history`
  ADD CONSTRAINT `history_ibfk_2` FOREIGN KEY (`patient_id`) REFERENCES `patient_data` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `messages`
  ADD CONSTRAINT `messages_ibfk_2` FOREIGN KEY (`patient_id`) REFERENCES `patient_data` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
--
ALTER TABLE `patient_address`
  ADD CONSTRAINT `patient_address_ibfk_1` FOREIGN KEY (`patient_id`) REFERENCES `patient_data` (`patient_id`) ON DELETE CASCADE ON UPDATE CASCADE;
